    ...
    <section className="bg-gradient-to-br from-[#e8eeff] via-[#dde6fb] to-[#eef2fb] flex items-center justify-center px-6 py-36 text-center">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <button className="bg-blue-600 hover:bg-blue-700 transition-colors text-white font-semibold px-7 py-2.5 rounded-lg text-sm cursor-pointer">
            Find Jobs
          </button>
          <button className="border-2 border-slate-300 hover:border-slate-400 transition-colors text-slate-800 font-semibold px-7 py-2.5 rounded-lg text-sm cursor-pointer">
            Post a Job
          </button>
        </div>
      </div>
